...
const ServicesPage: React.FC = () => {
    ...
    return (
        <div className="legae-landing" style={{ paddingTop: '8rem' }}>
            <SEO
                title="Agape Group Services | Transport, Construction, Security & Florist in Botswana"
                description="Agape Group offers comprehensive services in Botswana: safe school transport with lady-driven care, residential and commercial construction, professional security solutions, and exquisite florist & decor services. Your trusted partner across Gaborone and Francistown."
                keywords="Agape Group Botswana, Agape services, school transport Botswana, combi transport, lady-driven transport, cab services Botswana, construction Botswana, residential development, commercial projects, civil works, security services Botswana, manned guarding, CCTV surveillance, florist Botswana, flower delivery, event decor, wedding flowers, corporate flowers, transport construction security florist Botswana, Agape Group Gaborone, services Botswana, Botswana company services"
                url="/services"
            />
            {/* Navigation */}
            ...
            <div className="section-header" style={{ padding: window.innerWidth < 768 ? '0 5%' : '0 10%', marginBottom: '3rem', textAlign: 'center', flexDirection: 'column', alignItems: 'center' }}>
                <h2 style={{ fontSize: window.innerWidth < 768 ? '2rem' : '3rem', color: '#1A1A1A' }}>Safe & Reliable School Transport Now Available</h2>
                <p style={{ maxWidth: '800px', margin: '0 auto', fontSize: window.innerWidth < 768 ? '1rem' : '1.2rem' }}>
                    Give your child a comfortable, secure, and on-time ride to school with Agape Transport & Logistics.
                </p>
            </div>

            <section className="service-cards" style={{ padding: window.innerWidth < 768 ? '0 5% 4rem' : '0 10% 4rem' }}>
                <div style={{
                    display: 'grid',
                    ...
                    <div style={{ background: '#F9FAFB', border: '1px solid #eee', overflow: 'hidden', borderRadius: '0', display: 'flex', flexDirection: 'column' }}>
                        <div style={{ height: '250px', overflow: 'hidden' }}>
                            <img src={combiImg} alt="Combi" style={{ width: '100%', height: '100%', objectFit: 'contain', background: '#F9FAFB' }} />
                        </div>
                ...
                <div style={{ marginTop: '6rem', marginBottom: '3rem', textAlign: 'center', flexDirection: 'column', alignItems: 'center', padding: window.innerWidth < 768 ? '0 5%' : '0' }}>
                    <h2 style={{ fontSize: window.innerWidth < 768 ? '2rem' : '3rem', color: '#1A1A1A' }}>Agape Group Services</h2>
                    <p style={{ maxWidth: '800px', margin: '0 auto', fontSize: window.innerWidth < 768 ? '1rem' : '1.2rem' }}>
                ...
                <div style={{ textAlign: 'center', marginTop: '4rem', background: '#FDF2F2', padding: '3rem', borderRadius: '24px' }}>
                    ...
                    <p style={{ fontSize: '1.2rem', marginBottom: '2rem' }}>Book now: (+267) 77 593 604</p>
