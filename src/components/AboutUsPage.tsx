    ...
    return (
        <div className="legae-landing" style={{ paddingTop: '8rem' }}>
            ...
            <div className="section-header" style={{ padding: window.innerWidth < 768 ? '0 5%' : '0 10%', marginBottom: '3rem', textAlign: 'center', flexDirection: 'column', alignItems: 'center' }}>
                <h2 style={{ fontSize: window.innerWidth < 768 ? '2rem' : '3rem', color: '#1A1A1A', marginBottom: '2.5rem' }}>About Agape Group</h2>
                <p style={{ maxWidth: '800px', margin: '0 auto', fontSize: window.innerWidth < 768 ? '0.9rem' : '1rem', color: '#666', textTransform: 'uppercase', letterSpacing: '1px' }}>
                    DRIVEN BY EXCELLENCE BUILT ON TRUST<br />
                    CONSTRUCTION. LOGISTICS. SECURITY. CREATIVE SERVICES
                </p>
            </div>

            <section className="about-content" style={{ padding: window.innerWidth < 768 ? '0 5% 4rem' : '0 10% 4rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: window.innerWidth < 768 ? '1fr' : 'repeat(2, 1fr)', gap: '4rem', alignItems: 'center', marginBottom: '4rem' }}>
                    <div>
                        <h3 style={{ fontSize: window.innerWidth < 768 ? '1.8rem' : '2rem', marginBottom: '1.5rem', color: '#2D1414' }}>Our Vision</h3>
                ...
                <div style={{ padding: window.innerWidth < 768 ? '2rem 0' : '4rem 0' }}>
