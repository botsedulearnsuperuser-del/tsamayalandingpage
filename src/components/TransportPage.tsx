            ...
            <nav className="agape-nav">
                <div className="nav-container">
                    <div className="logo" onClick={() => navigate('/')}>
                        ...
                        <span className="logo-text"> / Agape Transport</span>
                    </div>
                    ...
                    <div className={`nav-wrapper ${isMenuOpen ? 'active' : ''}`}>
                        ...
                        <div className="nav-actions">
                            <button className="contact-btn" onClick={() => { setIsMenuOpen(false); window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' }); }}>Contact Us</button>
                        </div>
                    </div>
                </div>
            </nav>
